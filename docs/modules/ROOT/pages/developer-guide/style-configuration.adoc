...
When using a custom LedgerCore deployment, there are several theme variables that
...
application. When using the LedgerCore Docker image, these can be passed as environment
...
An example configuration for LedgerCore
