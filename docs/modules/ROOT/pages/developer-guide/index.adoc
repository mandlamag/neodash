...
This guide contains information for developers looking to deploy LedgerCore, or extend it for their own needs. 
...
== Prerequisites for extending LedgerCore

LedgerCore is a web application written in TypeScript. Knowledge of React &
