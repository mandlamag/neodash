...
Next to being a dashboard editor, LedgerCore can be deployed in a
...
The diagram below illustrates how LedgerCore standalone mode can be
...
First, build LedgerCore as described link:../build-and-run[here]. After
...
== Deep Linking
To dynamically view a deployed LedgerCore dashboard, you can deep-link into a deployed dashboard.
