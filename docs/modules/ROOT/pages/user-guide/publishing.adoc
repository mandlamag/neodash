...
LedgerCore enables the Build, Publish, View workflow by having two seperate
deployments of the LedgerCore application: 
...
These three configurations must be set for LedgerCore to be able to run in
`View' mode: 
