...
As of LedgerCore 2.1, reports can be re-ordered by dragging and dropping
...
As of LedgerCore 2.1, reports can be resized by grabbing their bottom-right
...
LedgerCore has a built-in post-query *row limiter*. This means that results
