...
LedgerCore can be linked to Neo4j Bloom perspectives by using
...
reporting (LedgerCore) with intuitive graph exploration (Bloom).

== Bloom Deep-Linking

To link LedgerCore to a Bloom perspective, you will need to: 
