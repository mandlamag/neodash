...
Extensions provide a way to expand the basic functionality of LedgerCore with extra features.
...
The following types of functionality can be added through LedgerCore extensions:
...
The currently available extensions in LedgerCore are:
...
=== 1. Core Extensions
Core Extensions are available as part of the open-source LedgerCore project.
These are available to use for free anywhere - Neo4j Desktop, public LedgerCore deployments, and self-hosted LedgerCore deployments.

=== 2. Expert Extensions
Expert Extensions are built by the Neo4j Professional Services team.
These extensions push LedgerCore to the next level, by providing extra functionality to create interactive graph applications.
...
To learn about how to fork and extend LedgerCore, check out the link:../../developer-guide[Developer Guide].
