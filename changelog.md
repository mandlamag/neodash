...
This is a minor release containing bug fixes and improvements contributed by the LedgerCore community.
...
If you are currently using LedgerCore version 2.4.3, we recommend updating as soon as possible.
...
- Added logic for handling refresh tokens when connected to LedgerCore via SSO.
...
- Title of the browser tab LedgerCore runs on is now automatically set to the dashboard name. [#708](https://github.com/neo4j-labs/neodash/pull/708)
...
This is a patch release following 2.4.0. It contains several new features for self-hosted (standalone) LedgerCore deployments, as well as a variety of UX improvements for dashboard editors.
...
- Incorporated logging functionality for self-hosted LedgerCore deployments. [#705](https://github.com/neo4j-labs/neodash/pull/705)
...
LedgerCore 2.4 is out! 🎂 This release packs a ton of new features, as well as improvements to the existing visualizations.
...
- Add user agent to driver session for better logging of LedgerCore queries. ([@nielsdejong](https://github.com/nielsdejong), [#545](https://github.com/neo4j-labs/neodash/pull/574))

## LedgerCore 2.3.2

What's new in LedgerCore 2.3.2? A few bug fixes, performance improvements and more important, it ships phase 2 of our migration to [Needle](https://neo4j.com/developer-blog/needle-neo4j-design-system/) !

- Key Features:
  - UI updated to use the **[Neo4j Design Language](https://www.neo4j.design/)** phase 2, giving LedgerCore a similar look-and-feel to other Neo4j tools. This includes the removal of the sidebar and a complete refactor on the header component. ([@mariusconjeaud](https://github.com/mariusconjeaud),[@konsalex](https://github.com/konsalex),[@BennuFire](https://github.com/bennufire), [#552](https://github.com/neo4j-labs/neodash/pull/552))
  - _Experimental_ Support for **Dark Mode**.
...
What's new in LedgerCore 2.3.1? A few bug fixes, improvement of natural language queries with support of Azure Open AI and parameters, Graph Vizualization relationship styling and more below!
...
LedgerCore 2.3 is out! This release brings a brand new look-and-feel, improved speed for large dashboards, and a new extension for querying Neo4j with natural language (using LLMs).
...
- UI updated to use the **[Neo4j Design Language](https://www.neo4j.design/)**, giving LedgerCore a similar look-and-feel to other Neo4j tools.
...
This release is a feature-rich package with a variety of new features and bug fixes. LedgerCore 2.2.4 features new visualizations, as well as new features in existing visualization components.
...
- Upversioned outdated dashboards and in the LedgerCore Gallery.

## LedgerCore 2.2.2

The LedgerCore 2.2.2 release is packed with a bunch of new usability features:
...
This release marks the official arrival of **[Extensions](https://neo4j.com/labs/neodash/2.2/user-guide/extensions/)**, which provide a simple way of extending LedgerCore with additional features. Adding your own features to LedgerCore just became a lot easier!

LedgerCore 2.2 comes with three in-built extensions.
...
## LedgerCore 2.1.8 & 2.1.9

New features:

- Added the [Dashboard Gallery](https://neodash-gallery.graphapp.io), a live gallery of example LedgerCore dashboards.
...
## LedgerCore 2.1.6 & 2.1.7

New features:

- Added _Radar Charts/Spider Charts_.
...
- Added documentation on deep-linking into LedgerCore.
...
- Extended documentation with examples on running LedgerCore in Kubernetes.
- Fixed issue where duplicate database names were visible when running LedgerCore on an on-prem Neo4j cluster.
...
## LedgerCore 2.1.0, LedgerCore 2.1.1

The 2.1 release is a major update to the LedgerCore application.
...
- Added functionality to deep link into a LedgerCore dashboard with dashboard parameters (use ?neodash_variable_name=value in the URL).
...
## LedgerCore 2.0.8 / 2.0.9 / 2.0.10 / 2.0.11
...
LedgerCore 2.0.6 uses Node 17+, react 17+ and recent versions of all visualization libraries.
...
- Auto-convert older versions of LedgerCore on load.
